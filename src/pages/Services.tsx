  ...
  return (
    <div className="pt-24">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <ScrollObserver animation="fade-up" threshold={0.2}>
            <div className={`mb-16 ${isRTL ? 'text-right' : 'text-left'}`}>
              ...
              <p className="text-body-large text-gray-600 max-w-xl leading-relaxed">
              ...
              >
                <div className={`flex flex-col items-center ${isRTL ? 'text-right' : 'text-center'} group`}>
                  ...
                  <div className="relative mb-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-gold to-gold/80 rounded-xl flex items-center justify-center text-white shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
      ...
      <ScrollObserver animation="fade-up" threshold={0.3}>
        <section className="py-20 bg-gradient-to-r from-gold to-gold/90 text-white relative overflow-hidden">
