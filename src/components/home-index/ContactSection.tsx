                    ...
                    <div className={`${isRTL ? 'text-right' : 'text-left'}`}>
                        <ScrollObserver animation={isRTL ? "fade-left" : "fade-right"}>
                            ...
                            <p className="text-gray-600 mb-6">
                                {isRTL
                                    ? 'نسعد بتواصلكم معنا للاستفسار عن خدمات التصميم الداخلي والديكورات الفاخرة. فريقنا جاهز للرد على استفساراتكم.'
                                    : 'We would be happy to hear from you regarding our luxury interior design and decoration services. Our team is ready to answer your inquiries.'}
                            </p>
                        </ScrollObserver>
                            ...
                            <ScrollObserver animation="fade-up" delay={200}>
                                <div className={`flex items-start gap-3 ${isRTL ? 'flex-row' : ''}`}>
                                    ...
                                    <div className={`${isRTL ? 'text-right' : 'text-left'} flex-1`}>
                                        ...
                                        <p className="text-gray-600">info@homeeast.com</p>
                                    </div>
                                </div>
                            </ScrollObserver>
