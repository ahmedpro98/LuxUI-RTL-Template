                    ...
                    <div className={`${isRTL ? 'text-right' : 'text-left'}`}>
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <ScrollObserver animation="fade-up" delay={150}>
                                <div className={`flex items-start gap-3 ${isRTL ? 'flex-row' : ''}`}>
                                    <div className="text-primary bg-primary/10 p-2 rounded-full mt-1 shrink-0">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ScrollObserver animation="fade-up" delay={400}>
                            <div className="mt-8">
                                <Link
                                    to="/contact"
                                    className="inline-block bg-primary text-white px-5 py-2 md:px-6 md:py-3 rounded-md hover:bg-primary-dark transition-colors duration-300"
                                >
