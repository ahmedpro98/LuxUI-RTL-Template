...
/**
 * Handles user inquiries and displays success messages
 */
const ContactForm: React.FC = () => {
  ...
  // Handles form submission with loading state and success feedback
  ...
  // Dynamic CSS classes based on language direction
